...
},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var on=e.jQuery,an=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=an),t&&e.jQuery===ie&&(e.jQuery=on),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),$(document).ready(function(){console.log("ready!")}),$(document).ready(function(){$("a.open-menu").click(function(e){var t=$("body"),n=$(".menu"),r=$(".hamburger"),i=t.hasClass("open"),o=i?-parseInt(t[0].style.top):t.scrollTop();n.toggleClass("open",!i),t.toggleClass("open",!i),r.toggleClass("open"),i?t.scrollTop(o):(t.css("top",-o),n.scrollTop(0))})});